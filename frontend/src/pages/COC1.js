...
function COC1() {
  ...
  const handleSubmitAnswer = useCallback(() => {
    ...
    try {
      ...
      fetch(`${API_URL}/api/coc1/quiz/submit`, {
        method: 'POST',
        headers: {
  ...
  const handleQuizCompletion = async () => {
    ...
    try {
      ...
      console.log('📤 Sending request to:', `${API_URL}/api/coc1/quiz/complete`);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-6 sm:py-8 px-3 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-2">COC 1</h1>
          <p className="text-sm sm:text-base text-blue-600">Master Operating Systems and Computer Software</p>
        </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-6 sm:p-8 md:p-12 border-2 border-blue-200 shadow-lg">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-gray-700 text-base sm:text-lg mb-6 sm:mb-8">
                Master Operating Systems and Computer Software through interactive quizzes. Each question has 20 seconds to answer.
              </p>

              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-8 sm:mb-10">
                <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm">
                  <p className="text-xl sm:text-2xl font-bold text-blue-600">29</p>
